...
var LiveRegion = function LiveRegion2(props) {
  ...
  return jsx(import_react6.Fragment, null, jsx(A11yText, {
    id
  ...
  _createClass(Select2, [{
    ...
    value: function renderFormField() {
      ...
      if (required && !this.hasValue()) {
        return React4.createElement(RequiredInput, {
          name,
    ...
    value: function renderLiveRegion() {
      ...
      return React4.createElement(LiveRegion, _extends({}, commonProps, {
